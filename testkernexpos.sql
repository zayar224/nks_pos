...
--
-- Host: localhost
-- Generation Time: Jun 13, 2026 at 02:57 PM
...
INSERT INTO `branches` (`id`, `shop_id`, `name`, `address`, `phone`, `created_at`) VALUES
(1, 1, 'Downtown Branch', '456 Main St, City', '555-0101', '2026-06-11 19:42:38'),
(4, 1, 'nks', 'no', '09', '2026-06-13 12:21:07');
...
INSERT INTO `currencies` (`id`, `code`, `exchange_rate`, `branch_id`, `shop_id`) VALUES
(1, 'USD', 1.0000, NULL, NULL),
(2, 'EUR', 0.8500, NULL, NULL);
...
INSERT INTO `payment_methods` (`id`, `name`, `is_active`, `branch_id`) VALUES
(1, 'Cash', 1, NULL),
(2, 'Card', 1, NULL),
(3, 'Digital', 1, NULL);
...
(1, 'NKS', '123 Main Street, City', '555-0100', '/uploads/1764090454420-5911088-Screenshot 2568-11-21 at 9.38.54 AM.png', '2025-06-17 09:55:50');
...
INSERT INTO `tax_rates` (`id`, `shop_id`, `name`, `rate`, `created_at`) VALUES
(1, 1, 'VAT', 7.00, '2026-06-11 19:42:38');
...
(2, 1, 'admin', 'admin@example.com', '$2b$10$2guRgwSd4EJXP1DoFegZWeuMK79XQTT/MnEalJt5Ki5xNMoNSvirW', 'admin', 1, '2026-06-11 19:42:39'),
(12, 1, 'testshopowner1', 'testshopowner1@gmail.com', '$2b$10$pTY7BeCL4s6LUhF7kcWjM.tY.nq0DSjgTIHIyCxt89SKw5/f4F9vG', 'shop_owner', 4, '2026-06-11 11:48:40');
...
--
ALTER TABLE `category_units`
  ADD CONSTRAINT `category_units_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`);
